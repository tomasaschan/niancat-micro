...
class MessageHandler:
    def __init__(self, commands, outbound_message_queue, notification_channel_id):
        self._notification_channel_id = notification_channel_id
        self._outbound_message_queue = outbound_message_queue
        self._command_parser = CommandParser(commands)
    ...
    def read_slack_messages(self, sc):
        ...
        for m in msgs:
            ...
            request_and_route = self.handle_if_message(sc, m)
